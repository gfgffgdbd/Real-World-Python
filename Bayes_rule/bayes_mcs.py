...
def main():
    ...
    while True:
        ...
        # choice = repeat_search(app.p1, app.p2, app.p3)
        choice = spread_search(app.p1, app.p2, app.p3)
...
if __name__ == '__main__':
    ...
    for _ in range(10000):
        main()
    print(f'Average number of searches is {sum_searches / 10000}')