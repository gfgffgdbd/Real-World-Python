...
class Search():
    ...
    def __init__(self, name):
        ...
        # Indicate coords that have been searched
        self.searched_dict = {
            1: [],
            2: [],
            3: []
    ...
    def conduct_search(self, area_num, area_array, effectiveness_prob):
        ...
        existing_coords = set(self.searched_dict[area_num])
        coords = [item for item in coords 
                  if item not in existing_coords]
        ...
        # Add searched coords to dict
        self.searched_dict[area_num].extend(coords)
